...
-- ----------------------------
INSERT INTO `alembic_version`(`version_num`)  VALUES ('9e4841093ef8');
-- ----------------------------
...
INSERT INTO `tb_admin`(`id`,`admin_name`,`_password`,`img`,`account`,`sex`,`state`,`_last_time`,`_create_time`)  VALUES ('3','test','pbkdf2:sha256:50000$II0medr6$fefc252fb793b17a7d6f7dfb9b2361867bf7de76f48044e269ec28b30667d6a1','/static/uploads/image/2018/6/3/1528021622.jpg','123456','1','1','1528345725','1528011755');
...
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('347','restore','127.0.0.1','还原备份成功！','1','1528343610');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('348','login','127.0.0.1','登录成功','3','1528345725');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('349','edit','127.0.0.1','修改操作员成功','1','1528429830');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('350','edit','127.0.0.1','修改操作员成功','1','1528429831');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('351','backup','127.0.0.1','备份成功！','1','1528429882');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('352','edit','127.0.0.1','行为：修改操作员；错误：密码不能为空','1','1528429896');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('353','backup','127.0.0.1','备份成功！','1','1528449337');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('354','add','127.0.0.1','行为：增加配置字段；错误：状态不能为空','1','1528456569');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('355','add','127.0.0.1','行为：新增分类；错误：图片长度必须为1-100位','1','1528457921');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('356','add','127.0.0.1','行为：新增分类；错误：别名长度必须为1-256位','1','1528457929');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('357','add','127.0.0.1','增加标签成功','1','1528457932');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('358','add','127.0.0.1','增加标签成功','1','1528457957');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('359','add','127.0.0.1','增加标签成功','1','1528457969');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('360','upload','127.0.0.1','上传成功','1','1528458005');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('361','add','127.0.0.1','增加标签成功','1','1528458008');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('362','add','127.0.0.1','行为：新增分类；错误：图片长度必须为1-100位','1','1528459929');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('363','add','127.0.0.1','行为：新增分类；错误：别名长度必须为1-256位','1','1528460038');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('364','add','127.0.0.1','增加分类成功','1','1528460608');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('365','add','127.0.0.1','增加分类成功','1','1528461222');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('366','add','127.0.0.1','增加标签成功','1','1528461438');
INSERT INTO `tb_log`(`id`,`log_type`,`ip`,`log_detail`,`admin_id`,`_create_time`)  VALUES ('367','add','127.0.0.1','增加标签成功','1','1528461927');
-- ----------------------------
...
CREATE TABLE `tb_resources_relationships` (
  ...
  PRIMARY KEY (`resources_id`,`posts_id`),
...
CREATE TABLE `tb_term_relationships` (
  ...
  `posts_id` int(11) NOT NULL,
  PRIMARY KEY (`term_taxonomy_id`,`posts_id`),
  KEY `posts_id` (`posts_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
-- ----------------------------
...
-- ----------------------------
INSERT INTO `tb_term_taxonomy`(`id`,`term_id`,`taxonomy`,`img`,`parent`,`count`)  VALUES ('1','2','1','','0','0');
INSERT INTO `tb_term_taxonomy`(`id`,`term_id`,`taxonomy`,`img`,`parent`,`count`)  VALUES ('2','3','2','','0','0');
INSERT INTO `tb_term_taxonomy`(`id`,`term_id`,`taxonomy`,`img`,`parent`,`count`)  VALUES ('3','4','2','','0','0');
-- ----------------------------
...
-- Records of tb_terms
-- ----------------------------
INSERT INTO `tb_terms`(`id`,`name`,`slug`,`term_order`)  VALUES ('2','牛逼','nb','99');
INSERT INTO `tb_terms`(`id`,`name`,`slug`,`term_order`)  VALUES ('3','厉害','厉害','99');
INSERT INTO `tb_terms`(`id`,`name`,`slug`,`term_order`)  VALUES ('4','测试','测试','99');
